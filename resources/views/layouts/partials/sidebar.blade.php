<nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
    <div class="sb-sidenav-menu">
        <div class="nav">
            ...
            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                <nav class="sb-sidenav-menu-nested nav">
                    <a class="nav-link" href={{ url('admin/products') }}>Product Lists</a>
                    <a class="nav-link" href={{url ('admin/warehouses')}}>Warehouses</a>
                    <a class="nav-link" href={{ url ('admin/suppliers') }}>Suppliers</a>
                    <a class="nav-link" href={{ url ('admin/orders') }}>Customer Orders</a>
                </nav>
            </div>
        ...
        <nav class="sb-sidenav-menu-nested nav">
            <a class="nav-link" href="{{ url('admin/users') }}">Customer Accounts</a>
            <a class="nav-link" href="{{ url('admin/useradmin') }}">Admin Accounts</a>
        </nav>
        </div>
